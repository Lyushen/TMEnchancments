...
// @license      GNU
// @version      1.3010
// @description  Extract phone number from WhatsApp Web and copy to clipboard on Ctrl+Y
...
(function() {
    ...
    function displayMessageBox(message, duration = 2000) {
            ...
            for (var i = 0; i < elements.length; i++) {
                ...
                if (/^(true_|false_)\d+@/.test(elem.dataset.id)) {
                    ...
                    if (phoneNumberMatch && phoneNumberMatch[2]) {
                        ...
                        displayMessageBox('Copied: ' + phoneNumberMatch[2]); // Display the message box
                        break;
                    }
                }
            }
